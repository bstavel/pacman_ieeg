...
for subject in subject_list:
    ...
    for row in subject_sig_df.iterrows():
        ...
        # pull out data
        last_away_roi = last_away_epochs.copy().pick_channels([mfg_elec, cing_elec])
    ...
    if attack == ['attack']:
        ...
        # final save
        granger_df.to_csv(f'/home/brooke/pacman/connectivity/ieeg/granger/granger_by_pair_ghost.csv')
    elif attack == ['noghost']:
        # final save
