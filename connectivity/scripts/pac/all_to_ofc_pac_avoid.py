...
t7_folder = '/global/scratch/users/bstavel/pacman/connectivity/ieeg/pac/avoid/to_ofc'
...
for sub in subject_list:
    ...
    for ofc_elec in ofc_list:
        ...
        for roi_pair in ofc_pairs_list:
            ...
            # get the phases
            phases = p.filter(last_away_epochs.info['sfreq'], roi_array, ftype='phase', n_jobs = 16)
            ...
            with open(f'{t7_folder}/{sub}_{roi_pair}_to_{ofc_elec}_pac.pkl', 'wb') as file:
                pickle.dump(p, file)
