...
for subject in subject_list:
    ...
    elec_list = pd.Series(hc_list + ofc_list + amyg_list + dlpfc_list)

    # Identify duplicated elements
    duplicated_list = elec_list[elec_list.duplicated()].tolist()

    # ROI lists
    roi_lists = [hc_list, ofc_list, amyg_list, dlpfc_list]
    ...
    for perm in range(0, permutations):
        ...
        ## combine ##
        last_away_roi = last_away_hc.add_channels([last_away_ofc, last_away_amyg, last_away_dlpfc])
