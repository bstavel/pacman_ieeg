...
for subject in subject_list:
    ...
    roi_coherence = compute_epoch_coherence(last_away_roi, last_away_roi.info.ch_names, (first_pair_indices, second_pair_indices), theta_freqs, theta_cycles, workers = 2)
